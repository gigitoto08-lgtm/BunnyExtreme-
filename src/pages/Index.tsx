...
// ✅ طريقة SEO بدون react-helmet
const useMeta = () => {
  useEffect(() => {
    document.title = "BunnyExtreme – Watch Free Adult Videos Online";
    const desc = document.querySelector('meta[name="description"]');
    if (desc) desc.setAttribute("content", "BunnyExtreme – Watch unlimited high-quality videos online. Explore categories like POV, Anal, Threesome, Hardcore, Deepthroat, and more. Daily updates, fast streaming, smooth experience.");
    
    const keywords = document.querySelector('meta[name="keywords"]');
    if (keywords) keywords.setAttribute("content", "adult videos, free porn, HD videos, POV, Anal, Threesome, Hardcore, Deepthroat, Group Sex, Leaked");

    const canonical = document.querySelector('link[rel="canonical"]');
    if (canonical) canonical.setAttribute("href", "https://yourdomain.netlify.app/");

    // Open Graph
    const ogTitle = document.querySelector('meta[property="og:title"]');
    if (ogTitle) ogTitle.setAttribute("content", "BunnyExtreme – Watch Free Adult Videos Online");

    const ogDesc = document.querySelector('meta[property="og:description"]');
    if (ogDesc) ogDesc.setAttribute("content", "Watch unlimited high-quality adult videos online. Explore categories like POV, Anal, Threesome, Hardcore, Deepthroat, and more. Daily updates, fast streaming, smooth experience.");

    const ogUrl = document.querySelector('meta[property="og:url"]');
    if (ogUrl) ogUrl.setAttribute("content", "https://yourdomain.netlify.app/");

    const ogImage = document.querySelector('meta[property="og:image"]');
    if (ogImage) ogImage.setAttribute("content", "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?w=1200&h=630&fit=crop");
  }, []);
};
...
const Index = () => {
  ...
  useMeta(); // ✅ إضافة SEO بدون react-helmet
